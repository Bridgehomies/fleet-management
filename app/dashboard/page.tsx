    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">0 expiring soon, 0 expired</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">0</div>
            <p className="text-xs text-muted-foreground mt-1">Out of 0 total</p>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            <Link href="/dashboard/documents/new">
              <Button variant="outline" className="w-full bg-transparent">Add Document</Button>
            </Link>
            <Link href="/dashboard/fleet/new">
              <Button variant="outline" className="w-full bg-transparent">Add Vehicle</Button>
            </Link>
            <Link href="/dashboard/alerts">
              <Button variant="outline" className="w-full bg-transparent">View Alerts</Button>
            </Link>
            <Link href="/dashboard/accounting">
              <Button variant="outline" className="w-full bg-transparent">View Transactions</Button>
            </Link>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">Latest documents added to the system</p>
            <Link href="/dashboard/documents" className="mt-4 inline-block">
              <Button size="sm" variant="outline" className="bg-transparent">View All</Button>
            </Link>
          </CardContent>
        </Card>

        <Card>
          <CardHeader><CardTitle>Recent Vehicles</CardTitle></CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">Latest vehicles added to your fleet</p>
            <Link href="/dashboard/fleet" className="mt-4 inline-block">
              <Button size="sm" variant="outline" className="bg-transparent">View All</Button>
